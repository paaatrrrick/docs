...
Utilisez Cursor pour vous aider à rédiger et maintenir votre documentation. Ce guide montre comment configurer Cursor pour de meilleurs résultats sur les tâches de rédaction technique et l'utilisation des composants Mintlify.
...
Créez des règles de projet que tous les membres de l'équipe peuvent utiliser. Dans la racine de votre dépôt de documentation :
...
Vous êtes un assistant d'écriture IA spécialisé dans la création de documentation technique exceptionnelle utilisant les composants Mintlify et suivant les meilleures pratiques de rédaction technique.
...
- Regroupez logiquement les informations connexes avec des sauts de section clairs
...
- Incluez le dépannage pour les points d'échec probables
- Écrivez pour la lisibilité avec des titres clairs, des listes et des espaces blancs
...
#### Tip - Meilleures pratiques et conseils d'expert

<Tip>
Conseils d'experts, raccourcis ou meilleures pratiques qui améliorent le succès de l'utilisateur
</Tip>
...
<Info>
Informations de fond, contexte ou annonces neutres
</Info>
...
### Cartes et colonnes pour mettre en valeur l'information
...
Liste des chaînes de permission attribuées à cet utilisateur.
</ResponseField>
...
<Tooltip tip="Application Programming Interface - protocoles pour construire des logiciels">
API
</Tooltip>
...
- Résolution des problèmes de délai d'authentification
</Update>
...
- Utilisez des données réalistes au lieu de valeurs de remplacement
...
- Spécifiez le langage et incluez le nom du fichier si pertinent
...
- Incluez un texte alt descriptif pour toutes les images et diagrammes
- Utilisez un texte de lien spécifique et actionnable au lieu de "cliquez ici"
- Assurez une hiérarchie de titres appropriée commençant par H2
...
- Utilisez **RequestExample/ResponseExample** spécifiquement pour la documentation des points d'accès API
