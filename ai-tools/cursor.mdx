...
<Card title="API documentation" icon="code" href="/api-reference/introduction">
  Explore the complete API reference and endpoint documentation.
</Card>
</CardGroup>
...
<Frame>
<img src="/images/hero-light.png" alt="Main dashboard showing analytics overview" />
</Frame>

<Frame caption="The analytics dashboard provides real-time insights">
<img src="/images/hero-dark.png" alt="Analytics dashboard with charts" />
</Frame>
