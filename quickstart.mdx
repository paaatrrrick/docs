...
<Card title="Write Content" icon="pen-to-square" href="https://mintlify.com/docs/page">
...
<Card title="Add code examples" icon="square-code" href="https://mintlify.com/docs/content/code">
