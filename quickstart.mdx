...
<AccordionGroup>
  ...
  <Accordion icon="rectangle-terminal" title="Start the preview server">
    ...
    <Check>You should see your documentation homepage with the default Mintlify styling.</Check>
  </Accordion>
</AccordionGroup>
...
<Card title="Write content" icon="pen-to-square" href="https://mintlify.com/docs/text">
...
<Card title="Add code examples" icon="square-code" href="https://mintlify.com/docs/code">
